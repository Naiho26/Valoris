...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: '48px' }}>
      <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '22px', fontWeight: 450, color: 'var(--navy)', marginBottom: '16px', letterSpacing: '-0.01em' }}>
        {title}
      </h2>
...
export default function Datenschutz() {
  return (
    <>
      ...
      <div style={{ background: 'var(--paper-2)', borderBottom: '1px solid var(--line)', padding: 'clamp(56px,7vw,90px) var(--pad-x) clamp(40px,5vw,56px)' }}>
        <div className="eyebrow">Rechtliches</div>
        <h1 className="s-title" style={{ marginBottom: '16px' }}>
