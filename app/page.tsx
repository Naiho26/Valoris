        ...
        <div className="warum-inner">
          ...
          <div>
            ...
            <div className="warum-points">
              {[
                { title: 'Schnelle Ersteinschätzung', text: 'Fundierte Markteinschätzung innerhalb von 48 Stunden — Diese erfolgt für Sie kostenfrei und unverbindlich.', delay: '0.15s', d: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 6v6l4 2' },
