    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-group">
        ...
        <input
          ...
          name="subject"
          type="text"
          placeholder="z. B. Mehrfamilienhaus Frankfurt"
          defaultValue={objekt ? `Anfrage: ${objekt}` : undefined}
        />
      </div>
      <div className="form-group">
      ...
      <button type="submit" className="form-submit" disabled={status === 'sending'}>
        {status === 'sending' ? 'Wird gesendet …' : <>Nachricht senden <span aria-hidden>→</span></>}
      </button>
      {status === 'success' && (
